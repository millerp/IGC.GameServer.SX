...
void _declspec(naked) LuckyItemEnhancementFix()
{
	...
	CheckLuckySoul:
		...
		JMP EDX;
	ItemInvalid:
		MOV EDX, 0x00993F48; // SXE3
		JMP EDX;
	}
}

// changed in season x e3
/*
...
void __declspec(naked) AlterPShopDisplayCurrency()
{
	...
	{
		PUSH pShopPriceTag;
		MOV EAX, DWORD PTR SS:[EBP-0x88]; // SXE3
		IMUL EAX,EAX, 0x64;
		MOV EDX, 0x0074AE6B; // SXE3 
		JMP EDX;
