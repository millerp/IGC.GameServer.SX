...
public:
	...
	int CommonExcOptionRand(int ItemKindA, BYTE *btSocketExcOption);
	...
	void _CalcEffectValue(OBJECTSTRUCT *lpObj, int iOperator, int iBaseValue, int iFormulaID, int & iEffectValue);
	void _SetOptionEffect(OBJECTSTRUCT *lpObj, BYTE *OptionEffect, int iEffectValue, BYTE btItemPos);

	void _SetEffect_Etc(OBJECTSTRUCT *lpObj, BYTE OptionEffectID, int iEffectValue);
	void _SetEffect_Rate(OBJECTSTRUCT *lpObj, BYTE OptionEffectID, int iEffectValue);
	void _SetEffect_Attack(OBJECTSTRUCT *lpObj, BYTE OptionEffectID, int iEffectValue, BYTE btItemPos);
	void _SetEffect_Defense(OBJECTSTRUCT *lpObj, BYTE OptionEffectID, int iEffectValue);
	void _SetEffect_Life(OBJECTSTRUCT *lpObj, BYTE OptionEffectID, int iEffectValue);
	void _SetEffect_Mana(OBJECTSTRUCT *lpObj, BYTE OptionEffectID, int iEffectValue);
	void _SetEffect_Skill(OBJECTSTRUCT *lpObj, BYTE OptionEffectID, int iEffectValue);
