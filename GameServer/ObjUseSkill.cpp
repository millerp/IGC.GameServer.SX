...
bool CObjUseSkill::LoadSkillInfo()
{
	...
	this->m_SkillData.SternTime						= ReadSkill.ReadInt("Skills", "SternTime", 10);
	this->m_SkillData.SwellManaTime					= ReadSkill.ReadInt("Skills", "SwellManaTime", 60);
	this->m_SkillData.CloakingTime					= ReadSkill.ReadInt("Skills", "CloakingTime", 60);
	this->m_SkillData.IceArrowTime					= ReadSkill.ReadInt("Skills", "IceArrowTime", 7);
	...
	this->m_SkillData.EnableWizardSkillWhileTeleport = ReadSkill.ReadInt("Skills", "CanDarkWizardUseSkillsWhileTeleport", 0);
