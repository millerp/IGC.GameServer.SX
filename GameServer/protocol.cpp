...
void GameProtocol::CGLiveClient(PMSG_CLIENTTIME * lpClientTime, short aIndex)
{
	...
	WLBufferDecrypt(&Decrypted[3], lpClientTime->h.size-3, "10149421897412987421798421879");
...
void GameProtocol::CGReqLuckyCoinTrade(PMSG_REQ_LUCKYCOIN_TRADE * aRecv, int aIndex)
{
	...
	ItemSerialCreateSend(aIndex, 235, 0, 0, Item.m_Type, Item.m_Level, Item.m_Durability, Item.m_Option1, Item.m_Option2, Item.m_Option3, aIndex, Item.m_NewOption, Item.m_SetOption, Duration, Item.m_SocketOption, 0);
